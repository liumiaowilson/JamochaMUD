...
public class Word implements CharSequence
{
  ...
  /**
   * Nos dice si estbad_char_replaced bien el primer carbad_char_replacedcter. Puesto que al principio de frase debe
   * de ser maybad_char_replacedsculas. 
   * 
   * @return Si estbad_char_replaced bien el primer carbad_char_replacedcter de la palabra.
   */
